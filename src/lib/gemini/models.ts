...
const chain = (...ids: string[]) => [...new Set(ids)];

/**
 * Fallback chains for the text roles. Preview-era models get overloaded at
 * peak times; a lighter model answering beats a demo that stalls.
 */
export const CHAINS = {
